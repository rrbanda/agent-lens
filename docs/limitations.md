...
|------------------|---------------|---------|
| Quality **gate** / block deploy | Skill compares scores to thresholds and returns a certification verdict in chat | Enforceable CI webhook: [#18](https://github.com/rrbanda/agent-lens/issues/18) |
